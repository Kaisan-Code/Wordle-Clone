...
Original file is located at
    https://colab.research.google.com/drive/1O6v_dWZOssUng6h0V1nHBNEwi2izTQT-
"""
...
def main():
  ...
  max_guess = guesses + 1 #To find what quess the user is on.
  ...
  def check_letters(guess):
    ...
    for i, letter in enumerate(guess):
      ...
      if letter == answer[i]:
        ...
        marks += " X"
    #Removes the first letter of the "marks" string.
  ...
  def make_suffix(): #For UI puropses
